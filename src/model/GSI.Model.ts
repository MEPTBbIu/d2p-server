...
export interface HeroAbilities {
  ability0?: AbilityBase;
  ability1?: AbilityBase;
  ability2?: AbilityBase;
  ability3?: AbilityBase;
}
...
export interface Map {
  ...
  win_team?: E.PlayerTeam;
}

export interface Player {
  activity?: E.PlayerActivity;
  assists?: number;
  deaths?: number;
  denies?: number;
  gold?: number;
  ...
  pro_name?: string;
  steamid?: string;
  team_name?: E.PlayerTeam;
  xpm?: number;
}

export interface PreviousGameState {
  abilities?: boolean | HeroAbilities;
  auth?: boolean | Auth;
  hero?: boolean | Hero;
  items?: boolean | PlayerItems;
  map?: boolean | Map;
  player?: boolean | Player;
  provider?: boolean | Provider;
  draft?: boolean | { [k: string]: any;};
  wearables?: boolean | Wearables;
  buildings?: boolean | Buildings;
}
/**
...
export interface Buildings {
  radiant?: RadiantBuilding;
}

export interface RadiantBuilding {
  dota_goodguys_tower1_top?: Building;
  dota_goodguys_tower2_top?: Building;
  dota_goodguys_tower3_top?: Building;
  dota_goodguys_tower1_mid?: Building;
  dota_goodguys_tower2_mid?: Building;
  dota_goodguys_tower3_mid?: Building;
  dota_goodguys_tower1_bot?: Building;
  dota_goodguys_tower2_bot?: Building;
  dota_goodguys_tower3_bot?: Building;
  dota_goodguys_tower4_top?: Building;
  dota_goodguys_tower4_bot?: Building;
  good_rax_melee_top?: Building;
  good_rax_range_top?: Building;
  good_rax_melee_mid?: Building;
  good_rax_range_mid?: Building;
  good_rax_melee_bot?: Building;
  good_rax_range_bot?: Building;
  dota_goodguys_fort?: Building;
}
...
export type PlayerActivity = "playing" | "menu" | "undefined";
/**
...
export type PlayerTeam = "dire" | "radiant" | "none" | "undefined";
...
export type NpcDotaHero =
  ...
  | "npc_dota_hero_zuus";
export type NpcDotaHeroAbility =
